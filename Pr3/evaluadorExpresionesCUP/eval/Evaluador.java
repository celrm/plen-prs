...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Fri Mar 12 10:47:24 CET 2021
  */
      ...
      switch (CUP$Evaluador$act_num)
        {
          ...
          case 0: // Exp ::= Exp MAS Term 
            {
              VSem RESULT =null;
		VSem exp1 = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.elementAt(CUP$Evaluador$top-2)).value;
		VSem term = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.peek()).value;
		 RESULT=new VSem();RESULT.val = exp1.val + term.val; 
          ...
          case 1: // $START ::= Exp EOF 
            {
              Object RESULT =null;
		VSem start_val = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.elementAt(CUP$Evaluador$top-1)).value;
		RESULT = start_val;
		...
		VSem term = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.peek()).value;
		 RESULT=new VSem();RESULT.val = term.val; 
          ...
          case 3: // Term ::= Term POR Fact 
            {
              VSem RESULT =null;
		VSem term1 = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.elementAt(CUP$Evaluador$top-2)).value;
		VSem fact = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.peek()).value;
		...
		String lexDeNum = (String)((java_cup.runtime.Symbol) CUP$Evaluador$stack.peek()).value;
		 RESULT = new VSem(); RESULT.val = Integer.valueOf(lexDeNum).intValue(); 
          ...
          case 6: // Fact ::= PAP Exp PCIERRE 
            {
              VSem RESULT =null;
		VSem exp = (VSem)((java_cup.runtime.Symbol) CUP$Evaluador$stack.elementAt(CUP$Evaluador$top-1)).value;
